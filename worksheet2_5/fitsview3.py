...
R = R[300:3600, 300:3600]
G = G[300:3600, 300:3600]
B = B[300:3600, 300:3600]
...
transformR = AsinhStretch(0.2) + PercentileInterval(99.6)
transformG = AsinhStretch(0.2) + PercentileInterval(99.9)
transformB = AsinhStretch(0.2) + PercentileInterval(99.6)
